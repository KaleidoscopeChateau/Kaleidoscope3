Shader "TriplanarUltimate/DualSurfaceShaderLightWeight" {
    ...
    Properties{
        ...
        SubShader{
            ...
            void surf(Input IN, inout SurfaceOutputStandard o) {
                ...
                fixed4 c2ol = tex2D(_UnderTex, uv2);
                half3 B1X = UnpackNormal(tex2D(_BumpMap, uv1));
                half3 B1Y = B1X;
                half3 B1Z = B1X;
                half3 B2X = UnpackNormal(tex2D(_BumpMapUnder, uv2));
                half3 B2Y = B2X;
                half3 B2Z = B2X;
                ...
                {
                    inormalX = lerp(UnpackNormal(tex2D(_InterpNormal, uv3)), UnpackNormal(tex2D(_SecInterpNormal, uv4)), _IntBlend);                //Interpolating between interpolator normal texture values
